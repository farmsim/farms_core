...
cdef enum:
    ...
    MUSCLE_FIBER_VELOCITY = 5
    MUSCLE_PENNATION_ANGLE = 6
    MUSCLE_ACTIVE_FORCE = 7
    MUSCLE_PASSIVE_FORCE = 8
    # TENDON
    MUSCLE_TENDON_LENGTH = 9
    MUSCLE_TENDON_FORCE = 10
    # FEEDBACKS
    MUSCLE_IA_FEEDBACK = 11
    MUSCLE_II_FEEDBACK = 12
    MUSCLE_IB_FEEDBACK = 13
