...
NDARRAY_V1_UI = shaped_array(np.uint, (...,))
NDARRAY_V1_UIC = shaped_array(np.uintc, (...,))
NDARRAY_33 = shaped_array(np.float32, (3, 3))
NDARRAY_44 = shaped_array(np.float32, (4, 4))
NDARRAY_V2_I = shaped_array(np.int64, (..., ...))
NDARRAY_V2_UI = shaped_array(np.uint, (..., ...))
NDARRAY_V2_D = shaped_array(np.double, (..., ...))
NDARRAY_X3_D = shaped_array(np.double, (..., 3))
NDARRAY_V3 = shaped_array(np.float32, (..., ..., ...))
